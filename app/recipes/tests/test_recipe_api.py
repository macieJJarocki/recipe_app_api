...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        recipe_auth_user = Recipe.objects.filter(user=self.user)
        serializer = RecipeSerializer(recipe_auth_user, many=True)
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Cooking')
        payload = {
            'title': 'Banana cake',
            'tags': [new_tag.id]
        }
...
class RecipeImageTests(TestCase):
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Chicken carriatore')
